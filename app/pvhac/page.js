...
export default function PvhacPage() {
  return (
    <article>
      ...
      <figure><Image src="/assets/mainst1948.jpg" alt="Pine Valley Main Street in 1948" width={634} height={424} /><figcaption>Main Street, 1948</figcaption></figure>
      <section><h2>About the Committee</h2><p>The Pine Valley Historical Advisory Committee was created by the Washington County Commission on June 4, 2002, to advise the commission and appropriate county departments on matters relating to the historical preservation of Pine Valley.</p><h3>The Committee’s Duties</h3><ul><li>Initiate and promote historic preservation of the historic character of the area.</li><li>Prepare proposals for preserving and enhancing the area’s historic character, public spaces, and buildings.</li><li>Coordinate with people, agencies, and organizations whose work affects the historic nature of the area.</li><li>Submit proposals for consideration in county plans and ordinances.</li></ul></section>
